...
{
	[format ["You are not allowed to disassemble weapons.<br/>Use the 'Move' option instead.", ["STR_R3F_LOG_action_deplacer_objet", "Move"] call getPublicVar]] spawn BIS_fnc_guiMessage;
};
