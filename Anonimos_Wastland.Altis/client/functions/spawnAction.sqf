...
{
	_header ctrlSetStructuredText parseText "<t size='0.5'> <br/></t><t size='1.33'>Pré carregando Nascimento...</t>";
};
...
//{
	_header ctrlSetStructuredText parseText "Parece que ocorreu um erro.<br/>tente novamente.";
	{
