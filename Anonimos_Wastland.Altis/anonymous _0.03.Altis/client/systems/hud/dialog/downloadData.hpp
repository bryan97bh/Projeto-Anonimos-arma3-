...
class SAT_DataDownloadDialog 
{
	idd = -1;
	movingEnable = true; 
	enableSimulation = true; 	
	onUnload = "call SAT_fnc_abortActionLaptop";
	
	controlsBackground[] = { MainBackground, SAT_DDD_closeText, SAT_DDD_head, SAT_DDD_line01L, SAT_DDD_line01R, SAT_DDD_line02L, SAT_DDD_line02R }; 	
	objects[] = { }; 
	controls[] = { SAT_DDD_close };
