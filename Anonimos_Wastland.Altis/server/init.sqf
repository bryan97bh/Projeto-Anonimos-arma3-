...
if (isServer) then
{
	...
	[
        ...
        "A3W_spawnBeaconSpawnRadius",
		"A3W_vehicleSaving",
		"A3W_staticWeaponSaving",
		"A3W_missionFarAiDrawLines",
		"A3W_atmEnabled",
		"A3W_atmMaxBalance",
		"A3W_atmMaxBalance_BLUFOR_OPFOR",
		"A3W_atmTransferFee",
		...
		"A3W_AjRevealPlayersOnAiKill",    //AJ Reveal Players on AI Kill
        "A3W_ClientSpawnDelayAfterRestart", //AJ
...
//waitUntil {sleep 0.5; !isnil "loaded"};
...
[] execVM "addons\serverRestartMessages\serverRestartMessages.sqf";
[] execVM "addons\statusBar\fn_aj_s_refreshTime.sqf";

//AJ Edit START /staynex
sleep (["A3W_ClientSpawnDelayAfterRestart", 5*1] call getPublicVar); //To avoid base objects bugusing during object positioning after restart
A3W_AllowClientToEnterGame = compileFinal "true";
publicVariable "A3W_AllowClientToEnterGame";
//AJ Edit END /staynex
