...
// ******************************************************************************************
//	@file Name: mission_HostileVTOL.sqf
...
_setupVars =
{
	_missionType = "AERONAVE VTOL NO AR";
...
_setupObjects =
{
	...
	_missionHintText = format ["Uma aeronave VTOL esta patrulhando a ilha, derrube e pegue sua carga!", _vehicleName, hostileairMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "O FDP foi morto, excelente!";
};
