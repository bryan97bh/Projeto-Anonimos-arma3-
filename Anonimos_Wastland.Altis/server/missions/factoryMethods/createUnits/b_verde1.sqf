...
_leader addHeadgear "H_HelmetSpecB_wdl";
_leader addGoggles "G_Tactical_Black";
_leader addUniform "U_B_CombatUniform_vest_mcam_wdl_f";
_leader addVest "V_PlateCarrierSpec_wdl";

_leader addMagazine "30Rnd_65x39_caseless_black_mag_Tracer";
...
_man2 addHeadgear "H_HelmetSpecB_wdl";
...
_man3 addHeadgear "H_HelmetSpecB_wdl";
_man3 addGoggles "G_Combat";
_man3 addUniform "U_B_CombatUniform_vest_mcam_wdl_f";
_man3 addVest "V_PlateCarrier1_wdl";
_man3 addBackpack "B_FieldPack_oli";

_man3 addMagazine "30Rnd_65x39_caseless_black_mag_Tracer";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man4 addHeadgear "H_HelmetSpecB_wdl";
_man4 addGoggles "G_Combat";
_man4 addUniform "U_B_CombatUniform_vest_mcam_wdl_f";
_man4 addVest "V_PlateCarrier1_wdl";

_man4 addMagazine "30Rnd_65x39_caseless_black_mag_Tracer";
_man4 addWeapon "arifle_MX_GL_Black_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man5 addHeadgear "H_HelmetSpecB_wdl";
_man5 addGoggles "G_Combat";
_man5 addUniform "U_B_CombatUniform_vest_mcam_wdl_f";
_man5 addVest "V_PlateCarrier1_wdl";

_man5 addMagazine "30Rnd_65x39_caseless_black_mag_Tracer";
_man5 addWeapon "arifle_MX_GL_Black_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man6 addHeadgear "H_HelmetSpecB_wdl";
_man6 addGoggles "G_Combat";
_man6 addUniform "U_B_CombatUniform_vest_mcam_wdl_f";
_man6 addVest "V_PlateCarrier1_wdl";

_man6 addMagazine "30Rnd_65x39_caseless_black_mag_Tracer";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man7 addHeadgear "H_HelmetSpecB_wdl";
_man7 addGoggles "G_Combat";
_man7 addUniform "U_B_CombatUniform_tshirt_mcam_wdL_f";
_man7 addVest "V_PlateCarrier1_wdl";

_man7 addMagazine "100Rnd_65x39_caseless_black_mag_tracer";
_man7 addWeapon "arifle_MX_SW_Black_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man8 addHeadgear "H_HelmetSpecB_wdl";
_man8 addGoggles "G_Combat";
_man8 addUniform "U_B_CombatUniform_vest_mcam_wdl_f";
_man8 addVest "V_PlateCarrier1_wdl";

_man8 addMagazine "30Rnd_65x39_caseless_black_mag_Tracer";
_man8 addWeapon "arifle_MX_Black_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man9 addHeadgear "H_HelmetSpecB_wdl";
_man9 addGoggles "G_Combat";
_man9 addUniform "U_B_CombatUniform_vest_mcam_wdl_f";
_man9 addVest "V_PlateCarrier1_wdl";

_man9 addMagazine "30Rnd_65x39_caseless_black_mag_Tracer";
_man9 addWeapon "arifle_MX_Black_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man10 addHeadgear "H_HelmetSpecB_wdl";
_man10 addGoggles "G_Combat";
_man10 addUniform "U_B_CombatUniform_vest_mcam_wdl_f";
_man10 addVest "V_PlateCarrier1_wdl";

_man10 addMagazine "30Rnd_65x39_caseless_black_mag_Tracer";
_man10 addWeapon "arifle_MX_Black_F";
