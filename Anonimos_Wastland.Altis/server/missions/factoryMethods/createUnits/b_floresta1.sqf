...
_leader linkItem "NVGoggles_tna_F";
_leader addHeadgear "H_HelmetB_Enh_tna_F";
_leader addGoggles "G_Tactical_Black";
_leader addUniform "U_B_T_Soldier_F";
_leader addVest "V_PlateCarrierSpec_tna_F";

_leader addMagazine "30Rnd_65x39_caseless_khaki_mag_Tracer";
_leader addWeapon "arifle_MX_khk_F";
_leader addPrimaryWeaponItem "muzzle_snds_H_khk_F";
_leader addPrimaryWeaponItem "acc_pointer_IR";
_leader addPrimaryWeaponItem "optic_Hamr_khk_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man2 linkItem "NVGoggles_tna_F";
_man2 addHeadgear "H_HelmetB_Enh_tna_F";
_man2 addGoggles "G_Combat";
_man2 addUniform "U_B_T_Soldier_F";
_man2 addVest "V_PlateCarrier1_tna_F";
_man2 addBackpack "B_AssaultPack_tna_F";

_man2 addMagazine "30Rnd_65x39_caseless_khaki_mag_Tracer";
_man2 addWeapon "arifle_MXC_khk_F";
_man2 addPrimaryWeaponItem "optic_Holosight_khk_F";

_man2 addMagazine "RPG32_F";
_man2 addWeapon "launch_RPG32_ghex_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man3 linkItem "NVGoggles_tna_F";
_man3 addHeadgear "H_HelmetB_Enh_tna_F";
_man3 addGoggles "G_Combat";
_man3 addUniform "U_B_T_Soldier_F";
_man3 addVest "V_PlateCarrier1_tna_F";
_man3 addBackpack "B_FieldPack_ghex_F";

_man3 addMagazine "30Rnd_65x39_caseless_khaki_mag_Tracer";
_man3 addWeapon "arifle_MXC_khk_F";
_man3 addPrimaryWeaponItem "optic_Holosight_khk_F";
...
_man4 addVest "V_PlateCarrier1_tna_F";

_man4 addMagazine "30Rnd_65x39_caseless_khaki_mag_Tracer";
_man4 addWeapon "arifle_MX_GL_khk_F";
...
_man5 addUniform "U_B_T_Soldier_F";
_man5 addVest "V_PlateCarrier1_tna_F";

_man5 addMagazine "30Rnd_65x39_caseless_khaki_mag_Tracer";
_man5 addWeapon "arifle_MX_GL_khk_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man6 addHeadgear "H_HelmetB_Enh_tna_F";
_man6 addGoggles "G_Combat";
_man6 addUniform "U_B_T_Soldier_F";
_man6 addVest "V_PlateCarrier1_tna_F";

_man6 addMagazine "30Rnd_65x39_caseless_khaki_mag_Tracer";
_man6 addWeapon "arifle_MXM_khk_F";
_man6 addPrimaryWeaponItem "muzzle_snds_H_khk_F";
_man6 addPrimaryWeaponItem "optic_SOS_khk_F";
_man6 addPrimaryWeaponItem "bipod_01_F_khk";
...
_man7 addVest "V_PlateCarrier1_tna_F";

_man7 addMagazine "100Rnd_65x39_caseless_khaki_mag_tracer";
_man7 addWeapon "arifle_MX_SW_khk_F";
_man7 addPrimaryWeaponItem "optic_ERCO_khk_F";
_man7 addPrimaryWeaponItem "bipod_01_F_khk";
...
_man8 addVest "V_PlateCarrier1_tna_F";

_man8 addMagazine "30Rnd_65x39_caseless_khaki_mag_Tracer";
_man8 addWeapon "arifle_MX_khk_F";
...
_man9 addVest "V_PlateCarrier1_tna_F";

_man9 addMagazine "30Rnd_65x39_caseless_khaki_mag_Tracer";
_man9 addWeapon "arifle_MX_khk_F";
...
_man10 addVest "V_PlateCarrier1_tna_F";

_man10 addMagazine "30Rnd_65x39_caseless_khaki_mag_Tracer";
_man10 addWeapon "arifle_MX_khk_F";
