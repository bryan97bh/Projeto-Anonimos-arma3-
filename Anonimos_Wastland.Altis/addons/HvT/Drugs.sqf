 ...
 for "_i" from 0 to 1 step 0 do 
{
	...
	if (_lsd >= 3 || _mar >= 3 || _coc >= 3 || _her >= 3) then
		{
			_title  = "<t color='#ff0000' size='1.2' align='center'>High Value Target (DRUGS)</t><br />";
			...
			_drugMarker setMarkerText (format ["High Value Target (DRUGS): %1", name player]);
			_drugMarker setMarkerColor "ColorRed";
			_drugMarker setMarkerType "mil_warning";
			sleep 30;
