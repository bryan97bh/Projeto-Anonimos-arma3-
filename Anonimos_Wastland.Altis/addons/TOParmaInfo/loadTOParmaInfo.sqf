...
_serverInfoString = format ["<t color='#A0FFFFFF'>Anônimos #%1 Wasteland %2</t>", call A3W_extdb_ServerID, worldName];
...
_generalInfoString = "Discord: https://invite.gg/anonimos";
