...
pp_create_terminals = {
...

  {
    ...
    _garage = (nearestObjects [_marker_pos, ["Land_i_Shed_Ind_F", "Land_Carrier_01_base_F", "Infrastructure_base_F"], 50]) select 0;
...
pp_get_near_vehicles = {
  ...
  def(_vehicles);
  _vehicles = (nearestObjects [_player, ["LandVehicle","Air","Ship"], 50]) select {!(_x getVariable ["A3W_lockpickDisabled",false]) && ((_x getVariable ['A3W_purchasedVehicle', false]) || (_x getVariable ['A3W_missionVehicle', false]))};
