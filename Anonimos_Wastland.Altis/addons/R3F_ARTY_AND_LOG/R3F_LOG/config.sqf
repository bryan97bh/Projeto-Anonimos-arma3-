...
/** 
 * Lista de nomes de classes de veículos ou objetos de carga que podem transportar objetos.
 * O segundo elemento dos arrays aninhados é a capacidade de carga (em relação ao custo de capacidade dos objetos).
 */
