...
#define RscHTML_sizeEx_P (((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.7)
...
class TOParmaInfoD
{
	...
	{	
		...
		class TAGeneralInfoBackground: RscText
		{
			...
			type = CT_STRUCTURED_TEXT;
			size = 0.030;
			text = "Facebook: @HardCoreWasteland Discord: discord.gg/jZ2mT9N";
			x = "0 * (((safezoneW / safezoneH) min 1.2) / 40)";
