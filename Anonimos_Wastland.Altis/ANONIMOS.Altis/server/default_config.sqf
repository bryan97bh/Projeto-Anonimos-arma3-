...
A3W_privateParkingCost = 2000;     // Cost to retrieve an individual vehicle from private parking
...
A3W_principalMissionsTimeout = 10*60;    // Time in seconds that a Main Mission will run for, unless completed
